...
- **2026-08-26 · 全屏修复本地替换**：以 clean Debug 构建可恢复替换 `/Applications/ForNow.app`，版本仍为 0.7.7（11）。安装前待定副本通过 `codesign --verify --deep --strict`，安装后主执行器与实际 Debug 代码 dylib 的 SHA-256 分别为 `0a5c16368459f12b63099630a914b0abee5f5fa0599c970de4f823c77a9606b1`、`141e3d9dff7b06c986d4a7d6cf1ff804058001688a3ea801173036ee0e6b57e9`，并从明确的 `/Applications/ForNow.app` 路径启动。旧正式签名 0.7.7（11）保存在废纸篓的 `ForNow-replaced-20260826-z10TzP/ForNow.app`；`~/Library/Application Support/ForNow` 未清理。此为本机 ad-hoc Debug 安装，不代表新 DMG、公证、网站或 Sparkle 版本已发布。
